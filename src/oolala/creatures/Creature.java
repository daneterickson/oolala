...
public class Creature {
   ...
   */
  public void setStatusInfection(boolean status) {
    isInfected = status;
  }
   ...
   * @return isInfected
   */
  public boolean getStatusInfection() {
    return isInfected;
  }
   ...
   */
  public boolean getCreatureVisibility() {
    return isCreatureVisible;
  }
   ...
   * @param game     will enable the Creature to only move when it will not hit the wall or hit
   *                 other Creatures
   */
  ...
  /**
   * This method will infect another Creature if it's nearby ahead, make the type of another
   * Creature the same with myType
   *
   * @param c    is another Creature to be evaluated
   * @param game tells us the radius for how nearby the user wants
   */
