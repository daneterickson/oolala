...
/**
 * Class that makes individual components such as TextFields and Buttons for ScreenDisplay and CanvasDisplay
 *
...
public class ScreenDisplayComponents {
    ...
    /**
     * Constructor that initializes ScreenDisplay by taking in a language that determines the properties file to use
     *
     * @param language
     */
