...
public class TurtleScreenDisplay extends ScreenDisplay{

  public TurtleScreenDisplay(TurtleView gameView, TurtleGame game, String language, int startX, int startY) {
