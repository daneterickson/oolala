...
public class Command {
    ...
    /**
     * Constructor for a Command object such that we can later evaluate whether it is one of the valid commands for each application
     *
    ...
    /**
     * This method will check whether the current Command's name gives a valid command by comparing it with an instance from every children Command classes.
     *
     * @return null if the Command is not valid; otherwise return its corresponding instance from ths child Command class
     */
     ...
     *
     * @return whether the Command return true or false (will be overridden in corresponding children Command classes)
     */
